...
export default function RemoveBookingScreen({route, navigation}) {
  ...
  return (
    <View
      ...
      <View
        ...
        <Icon name="calendar-remove" size={200} color={colors.button1} />
        <Paragraph style={{fontSize: 28, color: colors.text, padding: 15}}>
          Din bokning med id {booking} är borttagen!
        </Paragraph>
      </View>
      <Button
        mode="contained"
